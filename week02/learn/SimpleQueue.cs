public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Dequeue tried accessing index one instead of 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue inserted items at the front of the list instead of the back. Also the Deque removed the wrond index, which then returned incorrect values.
